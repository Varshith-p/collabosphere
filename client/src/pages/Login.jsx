...
const Login = () => {
  ...
  const handleSubmit = ({ endPoint, payload }) => {
    if (endPoint === "login") {
        ...
        <div className="w-[98%] mx-auto md:w-[28rem] mt-2 ring-blue-gray-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
          <div className="rounded-xl border border-gray-300 text-card-foreground shadow">
            <div className="flex flex-col space-y-1.5 p-6">
              <h3 className="font-semibold leading-none text-black">Login</h3>
              <p className="text-sm ">Login to your account here.</p>
            </div>
            ...
            <div className={" flex items-center p-6 pt-0"}>
              <button
                disabled={isLoading}
                onClick={() =>
                  handleSubmit({ endPoint: "login", payload: loginData })
                }
  ...
  return (
    <section className="w-[95%] md:w-[30rem] mx-auto min-h-screen flex items-center py-8">
