      ...
      <div defaultValue="sign in" className="bg-white rounded-lg p-4 w-[400px]">
        <ul className="grid w-full grid-cols-2 text-center bg-gray-100 py-1 rounded-md">
          <li
            ...
            className={
              selected === "login"
                ? "bg-white rounded-md mx-1 cursor-pointer"
                : "rounded-md mx-1 cursor-pointer text-gray-600"
            }
          >
            Login
          </li>
            ...
            <div className="rounded-xl border bg-card text-card-foreground shadow">
              ...
              <div className="p-6 pt-0 space-y-2">
                <div className="space-y-1 flex flex-col gap-2">
                  ...
                  <input
                    type="email"
                    className="border px-2 py-1 rounded-md border-gray-300 focus:outline-0 focus:border-gray-500"
                  />
                </div>
                <div className="space-y-1 flex flex-col gap-2">
