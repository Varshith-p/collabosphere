    ...
    <form onSubmit={handleSubmit}>
      <div className="flex w-full justify-between items-center px-[60px] py-6 border-b border-border-color">
        <div className="flex flex-col gap-3">
          <p>
            <Link to="/user/projects" className="text-[#61656C]">
              Projects /
            </Link>
            <span className="text-primary cursor-pointer"> Create Project</span>
          </p>
      ...
      <div className="py-6 px-[60px] w-[420px] flex flex-col gap-6">
        <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div
            ...
            } max-h-[160px] 2xl:max-h-[260px] p-2 rounded-[6px] border border-border-color overflow-auto fixed w-[300px] z-50 bg-white translate-y-20`}
          >
            {users
              .filter(
                (user) =>
          ...
          <div className="flex flex-col gap-3">
            {selectedUsers.map((user, index) => (
              ...
              >
                <p onClick={() => handleSelect(user)} className="flex flex-col">
                  <span>{user.name}</span>
